...
func TestUint64(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		if expected, actual := test.Expected, ui64; expected != actual {
...
func TestUint64ErrNotInRange(t *testing.T) {
	tests := []struct{
		Rune rune
		ExpectedErr error
	}{
...
func TestUint64ErrNotNumeric(t *testing.T) {
	tests := []struct{
		Rune rune
		ExpectedErr error
	}{
